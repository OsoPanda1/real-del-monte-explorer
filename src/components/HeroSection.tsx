    ...
    <section ref={containerRef} className="relative h-screen min-h-[800px] w-full overflow-hidden">
      ...
      >
        ...
        <motion.div
          ...
          className="flex items-center gap-2 mb-10 text-white/50"
        >
          ...
          <AnimatePresence mode="wait">
            {slides.map((slide, index) => (
              index === currentSlide && (
                ...
                >
                  <h1 className="font-display text-5xl md:text-7xl lg:text-8xl text-white mb-3 tracking-tight">
                    {slide.title}
                  </h1>
                  <p className="text-sm md:text-base text-[hsl(43,65%,52%)] tracking-[0.2em] uppercase">
                    {slide.subtitle}
                  </p>
                </motion.div>
              )
